...
//    let bundle = Bundle(forClass: GooglePlacesAutocompleteContainer.self)
...
extension GooglePlacesAutocompleteContainer: UISearchBarDelegate {
  ...
  */
  ...
  private func getPlaces(searchString: String) {
    ...
    GooglePlacesRequestHelpers.doRequest(url:
  ...
  private class func query(parameters: [String: AnyObject]) -> String {
    ...
    for key in Array(parameters.keys).sorted(by: <) {
      let value: AnyObject! = parameters[key]
        ...
        components = components + [(escape(string: key),escape(string: "\(value!)"))]
